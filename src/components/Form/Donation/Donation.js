            ...
            <div className={`input-group mb-3 ${isMobile ? '' : 'justify-content-end'}`}>
              ...
              {donate &&
                <>
                  ...
                  <input 
                    type={isMobile ? 'tel' : 'number'} className={`numericInput ${isMobile ? "form-control" : "text-center"}`} id="donation" name="donation" min={DONATION_RANGE[0]} max={DONATION_RANGE[1]} step="1" 
